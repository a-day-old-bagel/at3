...
static void HelloTriangleApplication::onWindowResized(GLFWwindow* window, int width, int height) {
...
static std::vector<char> HelloTriangleApplication::readFile(const std::string& filename) {
