...
#define WITH_COMPLEX_SHADER 0
	...
	#if DYNAMIC_UBO
		#define VERT_SHADER_NAME dynamic_ubo_vert_spv
		#define VERT_SHADER_LEN dynamic_ubo_vert_spv_len
	#else
		#define VERT_SHADER_NAME ubo_array_vert_spv
		#define VERT_SHADER_LEN ubo_array_vert_spv_len
	#endif
