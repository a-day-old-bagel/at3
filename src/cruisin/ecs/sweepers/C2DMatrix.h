...
class C2DMatrix {
  private:
    ...
    struct S2DMatrix {
      ...
      friend std::ostream &operator<<(std::ostream &os, const S2DMatrix &rhs) {
  ...
  public:
    ...
    inline void TransformSPoints(std::vector<SPoint> &vPoints);
...
inline void C2DMatrix::TransformSPoints(std::vector<SPoint> &vPoint) {
