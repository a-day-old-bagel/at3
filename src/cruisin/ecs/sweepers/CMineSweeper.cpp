...
//-------------------------------------------------------------------
void CMinesweeper::WorldTransform(std::vector<SPoint> &sweeper) {
...
//
//-----------------------------------------------------------------------
bool CMinesweeper::Update(std::vector<SVector2D> &mines) {
  ...
  std::vector<double> output = m_ItsBrain.Update(inputs);
...
//
//-----------------------------------------------------------------------
SVector2D CMinesweeper::GetClosestMine(std::vector<SVector2D> &mines) {
...
//-----------------------------------------------------------------------
int CMinesweeper::CheckForMine(std::vector<SVector2D> &mines, double size) {
