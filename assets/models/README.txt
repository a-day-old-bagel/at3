...
loading, will also be used to generate a btBvhTriangleMeshShape for use as static terrain in the engine. This can be
costly, so if you don't want your mesh to be used as a static terrain, don't call it anything starting with the word
"terrain."
